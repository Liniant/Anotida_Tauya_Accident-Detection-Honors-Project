                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Confirm",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    try {
                                        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(AccidentDetectionActivity.this);
                                        ...
                                        locationPostBody.setLatitude(latitude);
                                        locationPostBody.setLongitude(longitude);
                                        locationPostBody.setUser_id(String.valueOf(idw));
