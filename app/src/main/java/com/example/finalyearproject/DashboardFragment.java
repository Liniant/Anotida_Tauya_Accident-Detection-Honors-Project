...
public class DashboardFragment extends Fragment {
 ...
 public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
     ...
     String usernameq = getArguments().getString("username");
     int idq = getArguments().getInt("id");
     String roleq = getArguments().getString("role");

     if(roleq.toLowerCase().equals("admin") ||
             roleq.toLowerCase().equals("police") || roleq.toLowerCase().equals("ambulance")) {}else{mapsCard.setVisibility(View.GONE);}
